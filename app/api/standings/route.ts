...
const LEAGUE_CONFIG: Record<string, { id: number; season: string }> = {
  ...
  'acb':                  { id: 117, season: '2025-2026' },
  'turkish-bsl':          { id: 104, season: '2025-2026' },
  'aba-liga':             { id: 198, season: '2025' },
  'bbl':                  { id: 40,  season: '2025-2026' },
  'lega-a':               { id: 52,  season: '2025-2026' },
  'lkl':                  { id: 60,  season: '2025-2026' },
  'kls':                  { id: 85,  season: '2025-2026' },
  'serbian-super-league': { id: 86,  season: '2025-2026' },
