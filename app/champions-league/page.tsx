...
export default function ChampionsLeaguePage() {
  ...
  const allMatches = useMemo(() => {
    return (championsLeagueData as any).matches as LocalMatch[];
  }, []);
