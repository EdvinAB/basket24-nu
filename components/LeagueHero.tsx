...
interface LeagueHeroProps {
  league: 'NBA' | 'EuroLeague' | 'SBL' | 'ACB' | 'Turkish BSL' | 'ABA Liga' | 'BBL' | 'Greek Cup' | 'Lega A' | 'LKL' | 'KLS' | 'Serbian Super League' | 'EuroCup' | 'Champions League' | 'FIBA Europe Cup' | 'LNB' | 'World Cup';
}
...
const leagueInfo = {
  ...
  EuroCup: {
    title: 'EuroCup på TV & Stream',
    description: `Här hittar du streaming och sändningstider för EuroCup – Europas näst största klubbtävling i basket. EuroCup samlar de bästa lagen som inte kvalificerat sig till EuroLeague och erbjuder spännande basket på hög europeisk nivå med lag från Spanien, Italien, Turkiet, Ryssland och mer.\n\nMed basket24.nu får du en komplett översikt över alla EuroCup-matcher, speltider och kanaler, så att du enkelt kan följa turneringen live på TV och stream hela säsongen.`,
  },
  'Champions League': {
    title: 'Basketball Champions League på TV & Stream',
    description: `Här hittar du streaming och sändningstider för Basketball Champions League (BCL) – en av Europas stora basketturneringar organiserad av FIBA. BCL ger klubbar från hela Europa möjlighet att tävla på hög internationell nivå och har vuxit till att bli en av de mest spännande turneringarna i europeisk basket.\n\nMed basket24.nu får du en komplett översikt över alla Champions League-matcher, speltider och kanaler, så att du enkelt kan följa turneringen live på TV och stream.`,
  },
  'FIBA Europe Cup': {
    title: 'FIBA Europe Cup på TV & Stream',
    description: `Här hittar du streaming och sändningstider för FIBA Europe Cup – en europeisk basketturnering organiserad av FIBA Europa. Turneringen erbjuder lag från hela Europa möjligheten att tävla internationellt och är ett viktigt steg för klubbar som vill etablera sig på den europeiska scenen.\n\nMed basket24.nu får du en komplett översikt över alla FIBA Europe Cup-matcher, speltider och kanaler, så att du enkelt kan följa turneringen live på TV och stream.`,
  },
  LNB: {
    title: 'LNB (Franska ligan) på TV & Stream',
    description: `Här hittar du streaming och sändningstider för LNB Pro A (Betclic Élite) – Frankrikes högsta basketliga. Den franska ligan är en av Europas starkaste med lag som ASVEL Lyon-Villeurbanne, Paris Basketball och Le Mans Sarthe Basket.\n\nMed basket24.nu får du en komplett översikt över alla LNB-matcher, speltider och kanaler, så att du enkelt kan följa ligan live på TV och stream hela säsongen.`,
  },
  'World Cup': {
    title: 'FIBA Basketball World Cup 2027 på TV & Stream',
    description: `Här hittar du streaming och sändningstider för FIBA Basketball World Cup 2027 – basket-VM där landslag från hela världen tävlar om VM-titeln. Kvalspelet pågår redan nu med matcher från Europa, Amerika, Afrika, Asien och Oceanien inför slutspelet 2027.\n\nMed basket24.nu får du en komplett översikt över alla VM-kvalmatcher, speltider och kanaler, så att du enkelt kan följa Sveriges och övriga landslags väg mot VM 2027.`,
  },
};
